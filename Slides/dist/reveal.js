...
!(function (e, t) {
 ...
 var p = (function (e) {
  if (e) {
   var t = function (e) {
    ...
    b = function (e) {
     e.observeMutations &&
      ((e.observer = new MutationObserver(v(e, 1))), e.observer.observe(e.element, e.observeMutations));
    },
    w = {
     minSize: 16,
     maxSize: 512,
   ...
   var a = Object.assign({}, w, t),
    r = e.map(function (e) {
     ...
     return (
      ...
      { element: e, fit: v(t, i), unfreeze: f(t), freeze: y(t), unsubscribe: m(t) }
     );
    });
   return n(), r;
  }
 ...
 class v {
           ...
           (e) =>
            `url(${((e = "") =>
             encodeURI(e)
              .replace(/%5B/g, "[")
              .replace(/%5D/g, "]")
              .replace(/[!'()*]/g, (e) => `%${e.charCodeAt(0).toString(16).toUpperCase()}`))(decodeURI(e.trim()))})`
          )
          .join(","));
     else if (r) {
  ...
  layout(e) {
   Array.from(e.querySelectorAll(".r-fit-text")).forEach((e) => {
    p(e, { minSize: 24, maxSize: 0.8 * this.Reveal.getConfig().height, observeMutations: !1, observeWindow: !1 });
   });
  }
  unload(e) {
 ...
 const A = (e) => {
  ...
  if (i && i[1])
   return (
    (i = i[1]), { r: parseInt(i.slice(0, 2), 16), g: parseInt(i.slice(2, 4), 16), b: parseInt(i.slice(4, 6), 16) }
   );
 ...
 class R {
  ...
  sync(e) {
   ...
   e.classList.remove("has-dark-background"),
    ...
    (i.innerHTML = ""),
    s.background &&
     (/^(http|file|\/\/)/gi.test(s.background) || /\.(svg|png|jpg|jpeg|gif|bmp|webp)([?#\s]|$)/gi.test(s.background)
   ...
   if (i) {
    ...
    if (e && 0 !== e.a)
     return (
      ...
      (s ? (299 * s.r + 587 * s.g + 114 * s.b) / 1e3 : null) < 128 ? "has-dark-background" : "has-light-background"
     );
   }
   var s;
   return null;
 ...
 class C {
  ...
  createProgressBar() {
   ...
   const e = (e) => {
     ...
     (t = Math.max(Math.min(t, 1), 0)),
      (this.viewportElement.scrollTop = t * (this.viewportElement.scrollHeight - this.viewportElement.offsetHeight));
    },
    t = (i) => {
  ...
  syncPages() {
   ...
   (this.pages = o.map((i) => {
    ...
    (o += n.autoAnimatePages.reduce((e, t) => e + Math.max(t.scrollTriggers.length - 1, 0), n.autoAnimatePages.length)),
  ...
  async activate() {
   ...
   i.forEach(function (i, a) {
    if (!1 === i.classList.contains("stack")) {
     ...
     if (s) {
      const e = document.createElement("div");
      e.classList.add("slide-number"), e.classList.add("slide-number-pdf"), (e.innerHTML = v++), f.appendChild(e);
     }
 ...
 function $(n, o) {
   ...
   !1 !== k &&
    ...
    setTimeout(() => {
     Y.slides.classList.remove("no-transition"),
      ...
      Ce({ type: "ready", data: { indexh: c, indexv: h, currentSlide: p } });
    }, 1));
  }
  function be(e) {
  ...
  function Ee(t) {
   ...
   Y.wrapper.classList.remove(s.transition),
    ...
    Y.viewport.style.setProperty("--slide-height", "string" == typeof A.height ? A.height : A.height + "px"),
    A.shuffle && Ge(),
    ...
    a > 1 &&
     ...
     ((w = new V(Y.wrapper, () => Math.min(Math.max((Date.now() - Q) / J, 0), 1))), w.on("click", Tt), (Z = !1)),
  ...
  function xe(e) {
   Ce({ type: "slidechanged", data: { indexh: c, indexv: h, previousSlide: g, currentSlide: p, origin: e } });
  }
  function Pe(t, i) {
  ...
  function Fe(e, t) {
   ...
   return (
    ...
    "string" == typeof a.width && /%$/.test(a.width) && (a.width = (parseInt(a.width, 10) / 100) * a.presentationWidth),
  ...
  function Ye(e, i, s, a) {
   if (
    Ce({ type: "beforeslidechange", data: { indexh: void 0 === e ? c : e, indexv: void 0 === i ? h : i, origin: a } })
     .defaultPrevented
   )
    return;
   g = p;
   ...
   if (a && void 0 !== c) {
    ...
    for (let r = 0; r < a; r++) {
     ...
     if (
      ...
      for (let s = 0; s < d; s++) {
       let a = l[s];
       (i = r === (c || 0) ? Math.abs((h || 0) - s) : Math.abs(s - t)), e + i < n ? ee.load(a) : ee.unload(a);
      }
     }
    }
    dt() ? Y.wrapper.classList.add("has-vertical-slides") : Y.wrapper.classList.remove("has-vertical-slides"),
     lt() ? Y.wrapper.classList.add("has-horizontal-slides") : Y.wrapper.classList.remove("has-horizontal-slides");
   }
  }
  ...
  function ut() {
   let e = at();
   return { indexh: e.h, indexv: e.v, indexf: e.f, paused: Xe(), overview: le.isActive() };
  }
  function gt() {
  ...
  function ft({ skipFragments: e = !1 } = {}) {
   ...
   A.rtl
    ? (le.isActive() || e || !1 === oe.next()) && it().left && Ye(c + 1, "grid" === A.navigationMode ? h : void 0)
    : (le.isActive() || e || !1 === oe.prev()) && it().left && Ye(c - 1, "grid" === A.navigationMode ? h : void 0);
  }
  function yt({ skipFragments: e = !1 } = {}) {
   if (((q.hasNavigatedHorizontally = !0), ne.isActive())) return ne.next();
   A.rtl
    ? (le.isActive() || e || !1 === oe.prev()) && it().right && Ye(c - 1, "grid" === A.navigationMode ? h : void 0)
    : (le.isActive() || e || !1 === oe.next()) && it().right && Ye(c + 1, "grid" === A.navigationMode ? h : void 0);
  }
  ...
  function Rt(e) {
   "running" === _ &&
    ...
    ((_ = "idle"),
    Ce({ type: "slidetransitionend", data: { indexh: c, indexv: h, previousSlide: g, currentSlide: p } }));
  }
  function kt(e) {
  ...
  const Nt = {
    ...
    return (
     ...
     (function () {
      !0 === A.embedded
       ...
       : ((Y.viewport = document.body), document.documentElement.classList.add("reveal-full-page"));
   ...
   setState: function (e) {
    if ("object" == typeof e) {
     ...
     let t = s(e.paused),
      i = s(e.overview);
     "boolean" == typeof t && t !== Xe() && $e(t), "boolean" == typeof i && i !== le.isActive() && le.toggle(i);
    }
   },
