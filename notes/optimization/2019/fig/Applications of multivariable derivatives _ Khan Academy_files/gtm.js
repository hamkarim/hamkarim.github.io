...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,8,30,31,32,33,34,35]],
    [["if",1,2,3],["add",1,2,6,9,17,22,23,37]],
    [["if",0,4],["add",3,7,38]],
    [["if",0,5],["add",3,7,38]],
    [["if",0,6],["add",3,38]],
    [["if",5,7],["add",3,7,38]],
    ...
    [["if",1,3,9],["add",10]],
    [["if",0,10],["add",11,12]],
    [["if",11,12],["add",13,14,15,16,18,39]],
    [["if",13],["add",19,40]],
    [["if",14],["add",20,41]],
    [["if",2,15],["add",21,42]],
    [["if",0,16],["add",24,25,43]],
    [["if",17,18,19],["add",26,27,44]],
    [["if",12,20,21],["add",28,45]],
    [["if",12,21,22],["add",29]],
    [["if",12,21,23],["add",29,46]],
    [["if",0,24],["add",38]],
    [["if",0,25],["add",38]]]
},
...
return null},Ff=!1;if(I.querySelectorAll)try{var Gf=I.querySelectorAll(":root");Gf&&1==Gf.length&&Gf[0]==I.documentElement&&(Ff=!0)}catch(a){}var Cf=Ff;var Hd={},T=null,Uf=Math.random();Hd.B="GTM-WSX5PBP";Hd.Rb="6h1";Hd.Sd="";var Vf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Wf="www.googletagmanager.com/gtm.js";
var Xf=Wf,Yf=null,Zf=null,$f=null,ag="//www.googletagmanager.com/a?id="+Hd.B+"&cv=96",bg={},cg={},dg=function(){var a=T.sequence||0;T.sequence=a+1;return a};
